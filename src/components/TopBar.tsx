    ...
    <div className="navbar flex fixed h-16 bg-base-100 bg-transparent z-10 backdrop-blur-lg">
      ...
      <div className=" absolute w-full text-center flex justify-center">
        {isjoin && humanRoomName && (
          <div>
            <span className=' text-xl sm:text-3xl font-bold'>Room {humanRoomName}</span>
          </div>
        )}
      </div>
        ...
        <div>
            ...
            >
                ...
                <div>
                    ...
                    <span className=' text-lg'>IsAdmin：{mcurState.isAdmin ? "yes": "no"}</span>
                    <br/>
                    <span className=' text-lg'>Room Password：{roominfo_after_enter.passwd? roominfo_after_enter.passwd: "no passwd"}</span>
                    <br/>
                </div>
