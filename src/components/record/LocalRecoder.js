    ...
    return (
        <div className="container text-center">
            ...
            <div className="mb-2 flex w-full justify-center items-center flex-col pt-4">
                <span className=' text-lg font-bold mb-2'>⚠️For better experience, please use Chrome to record, Safari can't record speakers</span>
                {/* 选项 */}
                <div className="ml-4 form-control border rounded-md bg-black bg-opacity-10   w-[200px]">
                    <label className="cursor-pointer label">
                        <span className="label-text ">Record Microphone</span>
                        <input
                            type="checkbox"
                    ...
                    <label className="cursor-pointer label">
                        <span className="label-text ">Record Speaker</span>
                        <input
                            type="checkbox"
                    ...
                    <label className="cursor-pointer label">
                        <span className="label-text ">Record Screen</span>
                        <input
                            type="checkbox"
