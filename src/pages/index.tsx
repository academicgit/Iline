        ...
        <div className='Home flex justify-center items-center text-center mx-auto h-full w-full'>
            <div className='flex flex-col text-center justify-center'>
                <div className='text-xl md:text-5xl mb-2 hidden sm:block'>
                    I<Typist startDelay={1000}  typingDelay={110} loop={true}  cursor={<span className='cursor'>{this.state.cursor}</span>}   >LINE by Parv<Typist.Delay ms={1500} /><Typist.Backspace count={18} /></Typist>
            ...
            <footer className=' text-white gap-2 fixed bottom-0 text-xs sm:text-xl h-12 w-full py-1 px-2 flex items-center justify-center text-center bg-primary'>
                Hosted on 
                <a className=' text-accent-focus ' href="https://now.sh/" rel="noopener">
                Vercel
                </a>
                . Source code on 
                <a className=' text-accent-focus ' href="https://github.com/academicgit/iline" rel="noopener">
                GitHub
                </a>
                .
            </footer>
